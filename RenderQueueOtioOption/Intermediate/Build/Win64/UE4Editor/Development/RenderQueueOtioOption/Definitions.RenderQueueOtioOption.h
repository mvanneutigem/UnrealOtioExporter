#undef RENDERQUEUEOTIOOPTION_API
...
#define UE_PROJECT_NAME JenkinsAutomatioon
#define UE_TARGET_NAME JenkinsAutomatioonEditor
...
#define RENDERQUEUEOTIOOPTION_API DLLEXPORT
...
#define OPENTIMELINEIO_API DLLIMPORT
